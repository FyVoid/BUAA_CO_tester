...
if [ $DELAY_SLOT = "true" ]
    ...
    java -jar CO_mars.jar db nc $1/assemble.asm mc CompactLargeText coL1 ig 4000 > $1/std_output.txt
    ...
    echo "run assemble.asm with CS_mars to generate std_output.txt"
    java -jar CO_mars.jar nc $1/assemble.asm mc CompactLargeText coL1 ig 4000 > $1/std_output.txt
fi
